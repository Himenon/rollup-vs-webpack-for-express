...
/* eslint no-proto: 0 */ var setprototypeof = Object.setPrototypeOf || (({
    __proto__: []
...
function requireStreams() {
    ...
    var Buffer = require$$0$6.Buffer, Transform = require$$1$3.Transform;
    // == Exports ==================================================================
 ...
 * Variables.
 * @private
 */ /* istanbul ignore next */ var defer$1 = typeof setImmediate === 'function' ? setImmediate : function(fn) {
...
function requireShams() {
    ...
    hasRequiredShams = 1;
    /* eslint complexity: [2, 18], max-statements: [2, 33] */ shams = function hasSymbols() {
